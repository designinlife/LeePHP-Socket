...
class PHPMailer {
     ...
     * @access public
     */
    function setLanguage($langcode = 'zh_cn', $lang_path = 'language/') {
     ...
     * @return string
     */
    function base64EncodeWrapMB($str, $lf = null) {
     ...
     */
    function addEmbeddedImage($path, $cid, $name = '', $encoding = 'base64', $type = '', $disposition = 'inline') {
        if (!@is_file($path)) {
    ...
    protected function lang($key) {
        if (count($this->language) < 1) {
            $this->setLanguage('zh_cn'); // set the default language
        }
